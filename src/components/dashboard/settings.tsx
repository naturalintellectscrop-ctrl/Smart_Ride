  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Button
          onClick={handleSave}
          className={`bg-[#00D97E] text-[#0B0C0E] font-semibold hover:opacity-90 transition-opacity ${saved ? 'opacity-80' : ''}`}
        >
          {saved ? (
            <>
          ...
          <div className="grid gap-6">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="platformName" defaultValue="Smart Ride" className="bg-[#111214] border-white/10 text-white" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="currency" className="text-white/70">Default Currency</Label>
                    <Select defaultValue="UGX">
                      <SelectTrigger className="bg-[#111214] border-white/10 text-white">
                        <SelectValue />
                      </SelectTrigger>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-[#111214] rounded-xl border border-white/5">
                  <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {[
                ...
                <div key={index} className="p-4 bg-[#111214] rounded-xl border border-white/5 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input type="number" defaultValue={item.baseFare} className="bg-white/5 border-white/10 text-white" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-white/70">Per Km Rate (UGX)</Label>
                      <Input type="number" defaultValue={item.perKm} className="bg-white/5 border-white/10 text-white" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-white/70">Commission (%)</Label>
                      <Input type="number" defaultValue={item.commission} className="bg-white/5 border-white/10 text-white" />
                    </div>
                  </div>
                </div>
              ))}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input type="number" defaultValue={3} className="bg-[#111214] border-white/10 text-white" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-white/70">Preparation Time (minutes)</Label>
                    <Input type="number" defaultValue={20} className="bg-[#111214] border-white/10 text-white" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-white/70">Rider Pickup (minutes)</Label>
                    <Input type="number" defaultValue={10} className="bg-[#111214] border-white/10 text-white" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-white/70">Delivery Timeout (minutes)</Label>
                    <Input type="number" defaultValue={30} className="bg-[#111214] border-white/10 text-white" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label className="text-white/70">Merchant Accept/Reject (minutes)</Label>
                    <Input type="number" defaultValue={5} className="bg-[#111214] border-white/10 text-white" />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <Label className="text-white/70">Delivery Timeout (minutes)</Label>
                    <Input type="number" defaultValue={45} className="bg-[#111214] border-white/10 text-white" />
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-[#111214] border-white/10 text-white"
                    />
                  </div>
                  <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center justify-between p-4 bg-[#111214] rounded-xl border border-white/5">
                  <div>
