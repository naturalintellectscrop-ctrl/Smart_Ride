          ...
          <Card className="p-4 bg-[#1A1A24]/80 border-white/5 glass-card">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                { id: 'MTN_MOMO', label: 'MTN MoMo', icon: '📱', disabled: true, badge: 'Coming Soon' },
                { id: 'AIRTEL_MONEY', label: 'Airtel Money', icon: '📱', disabled: true, badge: 'Coming Soon' },
                { id: 'WALLET', label: 'Wallet', icon: '💳', disabled: true, badge: 'Coming Soon' },
              ].map((method) => (
                <button
                  key={method.id}
