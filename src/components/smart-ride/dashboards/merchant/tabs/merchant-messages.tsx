...
const initialChats: Chat[] = [
  {
    ...
    name: 'John D.',
    type: 'client',
    lastMessage: 'Thanks for the great food!',
    timestamp: '5 min ago',
    unread: 1,
    orderId: 'ORD-001',
  },
  {
    id: '2',
    name: 'Emmanuel K. (Rider)',
    type: 'rider',
    lastMessage: 'Picking up order ORD-002 now.',
...
const initialNotifications: Notification[] = [
  {
    id: '1',
    title: 'New Order',
    message: 'You have a new order #ORD-004 waiting for acceptance.',
    timestamp: '2 min ago',
    type: 'system',
    read: false,
  },
  {
    ...
    message: 'Payment of UGX 45,000 for order #ORD-003 has been confirmed.',
    timestamp: '1 hour ago',
    type: 'system',
    read: true,
  },
...
export function MerchantMessages() {
                      ...
                      <div className="flex items-center gap-3">
                        <Avatar className="h-12 w-12">
                          <AvatarFallback className={cn(
                            chat.type === 'client' ? "bg-blue-500/15 text-blue-400" : "bg-orange-500/15 text-orange-400"
                          )}>
