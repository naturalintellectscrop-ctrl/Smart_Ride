              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {filterChats().map((chat) => (
                    <Card 
                      key={chat.id} 
                      className="p-4 bg-white border-[#bec9bf]/30 hover:border-rose-500/30 transition-all cursor-pointer"
                ...
                <div className="space-y-2">
                  {filterNotifications().map((notification) => (
                    <Card 
                      key={notification.id} 
                      className={cn(
                        "p-4 bg-white border-[#bec9bf]/30 hover:border-rose-500/30 transition-all cursor-pointer",
