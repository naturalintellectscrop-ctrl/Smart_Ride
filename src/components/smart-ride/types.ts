export type UserRole = 'CLIENT' | 'RIDER' | 'MERCHANT' | 'PHARMACIST' | 'HEALTH_PROVIDER' | 'ADMIN';
...
// Task states — matches Prisma TaskStatus enum
...
// Task state transitions — aligned with backend isValidTransition()
