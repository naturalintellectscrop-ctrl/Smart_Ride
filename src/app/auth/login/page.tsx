        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-3xl p-8 neon-border animate-fade-up delay-200 gpu-accelerated">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3 animate-fade-up delay-800">
                {/* Google Sign-In */}
                <button
                  type="button"
                  onClick={handleGoogleSignIn}
                  disabled={googleLoading}
                  className="w-full h-11 bg-[#252530]/50 border border-white/10 rounded-xl flex items-center justify-center gap-2 text-white/70 hover:bg-[#252530] hover:border-[#00FF88]/30 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {googleLoading ? (
                    <Loader2 className="h-5 w-5 animate-spin" />
                  ) : (
                ...
                {/* Phone OTP - Most popular in Uganda */}
                <button
                  type="button"
                  onClick={() => router.push('/auth/phone-login')}
                  className="w-full h-11 bg-[#005f3a]/30 border border-[#00FF88]/20 rounded-xl flex items-center justify-center gap-2 text-[#00FF88] hover:bg-[#005f3a]/50 hover:border-[#00FF88]/40 transition-all duration-300"
                >
