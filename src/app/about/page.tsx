      ...
      <Section tone="raised">
        ...
        <div className="grid grid-cols-1 border-t border-mkt-border sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.title}
              className="border-b border-mkt-border py-6 sm:even:border-l sm:even:pl-8 sm:odd:pr-8 lg:border-l lg:px-8 lg:[&:nth-child(3n+1)]:border-l-0 lg:[&:nth-child(3n+1)]:pl-0"
            >
